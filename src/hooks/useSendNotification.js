...
const useSendNotification = () => {
  ...
  const sendNotification = async (dataType, userId, messageType,subMessageType) => {
    ...
    try {
      ...
      const notificationData = subMessageType && notificationMessage[messageType] && notificationMessage[messageType][subMessageType] ? notificationMessage[messageType][subMessageType] : notificationMessage[messageType];
