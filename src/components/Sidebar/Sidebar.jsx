...
function Sidebar({ isOpen, toggleSidebar }) {
  ...
  return (
    <div className={`flex fixed inset-0 z-50 ${isOpen ? "md:relative md:w-1/6" : "hidden"}`}>
    <div className="bg-black bg-opacity-25 w-full md:hidden md:w-0"></div> {/* This is the overlay */}
    <div className="absolute md:relative left-0 w-4/5 md:w-60 bg-white h-full shadow-lg">
      ...
      <ul className="flex flex-col space-y-3 space-x-3 text-sm font-medium h-screen overflow-y-auto text-gray-500 dark:text-gray-400 md:me-4 mb-4 md:mb-0">
        <h1 className="text-base text-center font-bold text-gray-700 text-nowrap">
          Admin Panel
        </h1>
