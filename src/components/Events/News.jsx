      ...
      <div className='flex'>
          ...
          <div className='m-3'>
                <div className='flex flex-col gap-4'>
                  ...
                  <div>
                    <textarea
                      className={`w-full relative z-1 px-4 py-2 border-gray-300 rounded-md focus:outline-none focus:ring-gray-400 dark:placeholder:text-gray-50 dark:text-white dark:bg-gray-600 ${notAllowed ? "cursor-not-allowed" : "cursor-auto"}`}
                      value={description}
